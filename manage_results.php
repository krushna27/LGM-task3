        ...
        <ul>
            <li class="dropdown" onclick="toggleDisplay('1')">
                ...
                <div class="dropdown-content" id="1">
                    ...
                    <a href="manage_classes.php">Show Class</a>
                </div>
            </li>
    ...
    <div class="main">
        ...
        <form action="" method="post">
            <fieldset>
                ...
                <input type="text" name="p3" id="" placeholder="c++">
                <input type="text" name="p4" id="" placeholder="java">
                <input type="text" name="p5" id="" placeholder="account">
