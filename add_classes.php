...
<body>
    ...
    <div class="title">
        <a href="dashboard.php"><img src="./images/logo1.png" alt="gdfgfd" class="logo"></a>
...
<?php 
    ...
    if (isset($_POST['class_name'],$_POST['class_id'])) {
        ...
        if (empty($name) or empty($id) or preg_match("/[a-z]/i",$id)) {
            if(empty($name))
                echo '<p class="error">Error: Please enter class</p>';
            if(empty($id))
                echo '<p class="error">Error: Please enter class id</p>';
            if(preg_match("/[a-z]/i",$id))
                echo '<p class="error">Error: Please enter valid class id</p>';
            exit();
        }
